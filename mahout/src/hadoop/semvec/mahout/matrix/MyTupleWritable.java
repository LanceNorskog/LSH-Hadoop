 ...
 */
public class MyTupleWritable implements Writable, Iterable<Writable> {
   ...
   * &quot;written&quot; values.
   */
  public MyTupleWritable(Writable[] vals) {
    written = 0L;
    values = vals;
  }
...
//    return 0 != ((1L << i) & written);
  ...
  public boolean equals(Object other) {
    if (other instanceof MyTupleWritable) {
      MyTupleWritable that = (MyTupleWritable)other;
