...
public final class MinkowskiMeasureTest extends MahoutTestCase {
  ...
  public void testMeasure() {
    ...
    DistanceMeasure unitDistanceMeasure = new MinkowskiDistanceMeasure(1.0);
    DistanceMeasure bigDistanceMeasure = new MinkowskiDistanceMeasure(5.0);
    ...
    double[][] unitDistanceMatrix = new double[3][3];
    double[][] bigDistanceMatrix = new double[3][3];
    ...
    for (int a = 0; a < 3; a++) {
      for (int b = 0; b < 3; b++) {
        ...
        unitDistanceMatrix[a][b] = unitDistanceMeasure.distance(vectors[a], vectors[b]);
        bigDistanceMatrix[a][b] = bigDistanceMeasure.distance(vectors[a], vectors[b]);
      }
    }
    ...
    for (int a = 0; a < 3; a++) {
      for (int b = 0; b < 3; b++) {
        ...
        assertTrue(bigDistanceMatrix[a][b] <= euclideanDistanceMatrix[a][b]);
        assertEquals(manhattanDistanceMatrix[a][b], unitDistanceMatrix[a][b], EPSILON);
      }
    }
  }
