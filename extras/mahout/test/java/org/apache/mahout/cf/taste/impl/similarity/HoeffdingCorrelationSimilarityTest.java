...
/** <p>Tests {@link HoeffdingCorrelationSimilarity}.</p> */
public final class HoeffdingCorrelationSimilarityTest extends SimilarityTestCase {
  ...
  public void testFullCorrelation1() throws Exception {
    ...
    double correlation = new HoeffdingCorrelationSimilarity(dataModel).userSimilarity(1, 2);
  ...
  public void testFullCorrelation1Weighted() throws Exception {
    ...
    double correlation = new HoeffdingCorrelationSimilarity(dataModel, Weighting.WEIGHTED).userSimilarity(1, 2);
    assertCorrelationEquals(1.0, correlation);
  }
  ...
  public void testFullItemCorrelation1() throws Exception {
    ...
    double correlation =
        new HoeffdingCorrelationSimilarity(dataModel).itemSimilarity(0, 1);
    assertCorrelationEquals(1.0, correlation);
  }
  ...
  public void testNoItemCorrelation2() throws Exception {
    ...
    double correlation =
        new HoeffdingCorrelationSimilarity(dataModel).itemSimilarity(1, 2);
    assertTrue(Double.isNaN(correlation));
  }
  ...
  public void testSimpleItemWeighted() throws Exception {
    ...
    ItemSimilarity itemSimilarity = new HoeffdingCorrelationSimilarity(dataModel, Weighting.WEIGHTED);
  ...
  public void testRefresh() throws Exception {
    ...
    new HoeffdingCorrelationSimilarity(getDataModel()).refresh(null);
  }
  ...
  public void testInferrer() throws Exception {
    ...
    UserSimilarity similarity = new HoeffdingCorrelationSimilarity(dataModel);
