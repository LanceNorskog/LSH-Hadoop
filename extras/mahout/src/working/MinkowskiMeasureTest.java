...
public final class MinkowskiMeasureTest extends MahoutTestCase {
  ...
  public void testMeasure() {
    ...
    assertEquals(0.0, manhattanDistanceMatrix[1][1], EPSILON);
    assertTrue(manhattanDistanceMatrix[1][0] > manhattanDistanceMatrix[1][1]);
    assertTrue(manhattanDistanceMatrix[1][2] < manhattanDistanceMatrix[1][0]);

    assertEquals(0.0, euclideanDistanceMatrix[2][2], EPSILON);
    assertTrue(euclideanDistanceMatrix[2][0] > euclideanDistanceMatrix[2][1]);
    assertTrue(euclideanDistanceMatrix[2][1] > euclideanDistanceMatrix[2][2]);
