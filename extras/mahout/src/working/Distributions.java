...
public class Distributions {
  ...
  /*
   * Project from normal distribution 0 -> 1.0 
...
//    return mapped;
  ...
  static public void main(String[] args) {
    ...
    System.out.println("0.2 -> " + shortPrint(normal2linear(0.2)));
    System.out.println("0.3 -> " + shortPrint(normal2linear(0.3)));
    System.out.println("0.4 -> " + shortPrint(normal2linear(0.4)));
    System.out.println("0.5 -> " + shortPrint(normal2linear(0.5)));
    System.out.println("0.6 -> " + shortPrint(normal2linear(0.6)));
    System.out.println("0.7 -> " + shortPrint(normal2linear(0.7)));
    System.out.println("0.8 -> " + shortPrint(normal2linear(0.8)));
    System.out.println("0.9 -> " + shortPrint(normal2linear(0.9)));
  }

  private static String shortPrint(double d) {
   ...
   * Cribbed from innumerable statics web sites.
   * Maps a linear value to the matching normal distribution
   */
  static private double[] CDF = {
