...
/**
 * <p>
 * An implementation of the Hoeffding D statistic correlation. For users X and Y, the following values are calculated:
 * </p>
 * 
 * <ul>
 ...
 * </p> 
 */
public final class HoeffdingCorrelationSimilarity extends AbstractSimilarity {

  /**
   * @throws IllegalArgumentException if {@link DataModel} does not have preference values
   */
  public HoeffdingCorrelationSimilarity(DataModel dataModel) throws TasteException {
   ...
   * @throws IllegalArgumentException if {@link DataModel} does not have preference values
   */
  public HoeffdingCorrelationSimilarity(DataModel dataModel, Weighting weighting) throws TasteException {
