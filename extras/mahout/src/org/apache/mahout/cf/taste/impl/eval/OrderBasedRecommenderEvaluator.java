...
//      if (recs1.isEmpty() || recs2.isEmpty())
//        continue;
...
//     switch (formula) {
//     case BUBBLE:
//       double bubble = bubbleCrossSort(itemsL, itemsR);
//       return Math.log(bubble);
//     case COMMON:
//       int common = findCommonItems(itemsL, itemsR);
//       // maybe the log?
//       return Math.log(common);
//     case HAMMING:
...
//       if (formula == Formula.WILCOXON) {
//         double normalW = normalWilcoxon(vectorZ, vectorZabs);
//         return Math.sqrt(normalW);
//       }
//       if (formula == Formula.MEANRANK) {
//         double meanRank = getMeanRank(vectorZabs);
//         return Math.sqrt(meanRank);
//       }
//     };
//     default:
//       return -1;
...
//   }
//
//   private int findCommonItems(Long[] itemsL, Long[] itemsR) {
//     FastIDSet left = new FastIDSet();
//     for(Long item: itemsL) {
//       left.add(item);
//     }
//     int count = 0;
//     for(Long item: itemsR) {
...
//    * Cross sort: sort itemsR using itemsL as the reference order.
//    */
//   long bubbleCrossSort(Long[] itemsL, Long[] itemsR) {
