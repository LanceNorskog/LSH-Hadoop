...
public class Copy_5_of_SliceSampler1D<T> extends Sampler<T> {
   ...
   */
  public Copy_5_of_SliceSampler1D(DoubleFunction mapper, Random rnd, double width, double low, double high) {
    this.mapper = mapper;
    this.rnd = rnd;
    this.width = width;
    this.low = low;
