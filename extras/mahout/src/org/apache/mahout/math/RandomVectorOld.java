...
//  protected RandomVectorOld(int size) {
//    super(size);
...
//
//  @Override
//  public RandomVectorOld clone() {
//    return new RandomVectorOld(cardinality, seed, stride, mode);
//  }
//
//  /**
//   * @return true
...
//    if (o.getClass() == RandomVectorOld.class) {
//      RandomVectorOld r = (RandomVectorOld) o;
