...
CP="\
/cygwin/home/lance/open/hadoop/hadoop-0.20.2/lib/commons-cli-1.2.jar;\
...
/cygwin/home/lance/open/mahout/core/target/dependency/uncommons-maths-1.2.jar;\
/cygwin/home/lance/open/mahout/core/target/dependency/guava-r03.jar;\
"
...
# [ $# -ge 2 ] || exit "Usage: sample.sh low high"


java -classpath "$CLASSPATH" $OPTS hack.Sample "$1" "$2" 
