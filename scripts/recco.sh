...
LAST="/cygwin/home/lance/github/LSH-Hadoop/project/test/resources/SV_GL-corners-site.xml"
...
java -Xmx400m "$OPTS" org.apache.mahout.cf.taste.impl.model.TestGLSimplexRecommender $1
