...
public final class ItemDimWritable extends VarLongWritable {
  
  private long dimension;
  
  public ItemDimWritable() {
    // do nothing
  }
  
  public ItemDimWritable(long itemID, long dimension) {
    super(itemID);
    this.dimension = dimension;
  }
  
  public ItemDimWritable(ItemDimWritable other) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof ItemDimWritable)) {
      return false;
    }
    ItemDimWritable other = (ItemDimWritable) o;
  ...
  @Override
  public ItemDimWritable clone() {
    return new ItemDimWritable(get(), dimension);
  }
